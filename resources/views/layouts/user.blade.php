...
<style>
   ...
   .card-title ,p,.input-item-label,.input-bordered ,input,.text-dark,h4,.copyright-text,.footer-links > li > a,.page-title,.total-amount-lead,.total-amount,.total-amount-lg,.total-title-lead {
            ...
            <div class="container">
                <div class="navbar-innr">
                    <ul class="navbar-menu" id="main-nav">
                        ...
                        <li><a href="{{ route('user.referrals') }}"><em class="ikon ikon-user"></em> {{__('Referrals')}}</a></li>
