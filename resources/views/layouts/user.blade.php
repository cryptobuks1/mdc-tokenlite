            ...
            <div class="container">
                <div class="navbar-innr">
                    <ul class="navbar-menu" id="main-nav">
                        ...
                        <li><a href="{{ route('user.referrals') }}"><em class="ikon ikon-user"></em> {{__('My Referrals')}}</a></li>
                        @if(gws('user_mytoken_page') == 1)
                        <li><a href="{{ route('user.token.balance') }}"><em class="ikon ikon-my-token"></em> {{ __('Token Balance') }}</a></li>
                        @endif
                        <li><a href="{{ route('user.airdrop') }}" target="_blank"><em class="ikon ikon-coins"></em> {{ __('Airdrop') }}</a></li>
