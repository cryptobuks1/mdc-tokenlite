...
Route::prefix('user')->middleware(['auth', 'user', 'verify_user', 'g2fa'])->name('user.')->group(function () {
    ...
    Route::get('/contribute', 'User\TokenController@index')->name('token');
     Route::get('/transfer', 'User\UserController@transfer')->name('transfer');
...
Route::prefix('admin')->middleware(['auth', 'admin', 'g2fa', 'ico'])->name('admin.')->group(function () {
    ...
    Route::name('ajax.')->prefix('ajax')->group(function () {
        ...
        Route::post('/stages/pause', 'Admin\IcoController@pause')->middleware('ico')->name('stages.pause');
        Route::post('/stages/active', 'Admin\IcoController@active')->middleware('ico')->name('stages.active');
